...
@class NSBundle;
@class NSCoder;
SWIFT_CLASS("_TtC7Pokedex28PokemonDetailsViewController")
...
SWIFT_CLASS("_TtC7Pokedex25PokemonListViewController")
@interface PokemonListViewController : UIViewController <UISearchBarDelegate, UITableViewDataSource, UITableViewDelegate>
